...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'ABHISHEK SER' : process.env.ALL_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'Rudhra' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/6p3x1x6.jpeg' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/princerudh/' : process.env.SOCIAL_MEDIA,
    ...
    SUDO: process.env.SUDO === undefined ? '919895339960,0' : process.env.SUDO,
    DEBUG: DEBUG,
